...
public class FrequencyBandAnalyser : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /*
        if ( _LiveAudio ) {
            _AudioSource.clip = Microphone.Start( Microphone.devices[0], true, 1, 44100 );
    ...
    {
        //---   POPULATE SAMPLES
        _AudioSource.GetSpectrumData(_SampleBuffer, 0, FFTWindow.Blackman);
