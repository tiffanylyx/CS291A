...
namespace Facebook.WitAi
{
    ...
    public class WitRequest
    {
        ...
        public Action<WitResponseArray> onFullTokens;
        ...
        private bool ProcessStringResponse(string stringResponse)
        {
            ...
            if(final)
			{
				WitResponseArray tokens = (WitResponseArray)responseData["speech"]["tokens"];
                MainThreadCallback(() => onFullTokens?.Invoke(tokens));
            }
